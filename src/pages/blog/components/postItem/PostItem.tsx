...
export default function PostItem({ post, handleDeletePost, handleStartEditingPost }: PostItemType) {
  return (
    <div className='flex flex-col items-center overflow-hidden rounded-lg border md:flex-row'>
      ...
      <div className='flex flex-col gap-2 p-4 lg:p-6'>
        <span className='text-sm text-gray-400'>{post.publicDate}</span>
        ...
        <div>
          <div className='inline-flex rounded-md shadow-sm' role='group'>
            <button
              ...
              onClick={(e) => handleStartEditingPost(post.id)}
            >
              Edit
            </button>
            <button
